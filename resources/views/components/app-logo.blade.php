...
<div {{ $attributes }}>
    @switch($type)
        ...
        @case('admin')
            <svg id="code_snippet" data-name="code snippet" height="{{ $size }}"
                viewBox="0 0 104 24" width="{{ $size * 5 }}" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="26" y="18" fill="{{ $color }}">Admin</text>
            </svg>
        @break
