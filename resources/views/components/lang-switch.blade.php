<div {{ $attributes->merge(['class' => 'd-flex gap-2 align-items-center']) }}>
    <a href="{{ route('locale.setting', 'en') }}">
        <svg width="32px" height="24px" id="flag-icons-gb" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    ...
    <a href="{{ route('locale.setting', 'es') }}">
        <svg width="32px" height="24px" id="flag-icons-es" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
